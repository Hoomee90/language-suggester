...
function showResults() {
  ...
  if (answersValue >= 7.5) {
    ...
    resultsText.innerText = "You an excitable person always jumping onto the latest thing. Perhaps you've dabbled in many languages, or are taking this quiz itself as an impulse. Either way, WoodWork is right for you. Simultaneously the lowest and highest-level programming language possible, it is versatile in ways that isolated minds struggle to comprehend. The only trouble you may encounter is that this language doesn't actually exist yet. Luckily, that just means you have something to look forward to!";
  } else if (answersValue >= 4) {
    resultsTitle.innerText = "HTML, CSS, and Javascript";
    resultsText.innerText = "You are a middle of the road individual, who's just looking for a useful language to immerse themselves in. You might be talented at other things such as writing or an instrument and are looking to round out your skillset. Perhaps you have a strong deadpan sense of humor and enjoy creating and consuming media with sensibilities leaning towards the surreal. Unfortunately, seeing as there can only be one, you are obligated find me and engage in a duel to the death. Sorry, I don't make the rules.";
